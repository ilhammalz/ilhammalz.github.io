...
const authConfig = {
    "siteName": "https://drive.qano.workers.dev", // Website name
    ...
    "refresh_token": "1//0gIVIidXnb2AaCgYIARAAGBASNwF-L9IriHiXTS0Up7eYwYlrfzYOiTh5kK9gl0TVAne7qi0mQdSsgkskTgdNND40-0OmLgqFwCU", // Authorize token
    ...
    "roots":[
      {
          "id": "11PH9iVZBdzet8DcGb_XNvbP75kmMh3ys",
          "name": "About",
          "protect_file_link": false,
         // "auth": {"username":"password"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "11m0yUcTFBW3qjchSxwcN9INZn1i1NUqx",
          "name": "Mirror Drive",
          "protect_file_link": false,
         // "auth": {"username":"password"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "11LkRkL959dTHw7nlB-nikWX6oZZXxAbU", 
          "name": "TeleFilmX",
          "protect_file_link": true,
         // "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AP80d7Hs3xUJUk9PVA",
          "name": "4K Movies",
          "protect_file_link": false,
          "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AE5FzA6jLcwSUk9PVA",
          "name": "Anime Batch",
          "protect_file_link": false,
          "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AAiZhrDEjH4wUk9PVA",
          "name": "Anime Series",
          "protect_file_link": false,
          "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AEIrVCEjbwbxUk9PVA",
          "name": "Drama Korea",
          "protect_file_link": false,
          "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AByrtWaOJZ_0Uk9PVA",
          "name": "Film Box Office",
          "protect_file_link": false,
          "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AGZpYX1Bm572Uk9PVA",
          "name": "Film Indonesia",
          "protect_file_link": false,
          "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AGsvX_-VDvwRUk9PVA",
          "name": "Kartun",
          "protect_file_link": false,
         "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AE5W4ljCo0KLUk9PVA",
          "name": "TV & Netflix Series",
          "protect_file_link": false,
          "auth": {"Qano22":"@XXX666"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          ...
          "name": "PRIVATE",
          "protect_file_link": true,
          "auth": {"Qano22":"@XXX999"} /* Remove double slash before "auth" to activate id password protection */
      },
    ]};
...
const uiConfig = {
    ...
    "contact_link": "https://t.me/Qano22", // Link to Contact Button on Menu
    "copyright_year": "2050", // year of copyright, can be anything like 2015 - 2020 or just 2020
    "company_name": "Qano", // Name next to copyright
    "company_link": "https://t.me/Qano22", // link of copyright name
    ...
    "unauthorized_owner_link": "https://t.me/Qano22", // Unauthorized Error Page Link to Owner
    "unauthorized_owner_email": "andrianqano@gmail.com", // Unauthorized Error Page Owner Email
...
<hr><center>QanoDriveIndex/${uiConfig.version}</center>
<hr><center>Please contact Me at <a href="${uiConfig.unauthorized_owner_link}">Telegram.</a></center>
</body>
</html>`
